...
export const dictionary = {
  en: {
    ...
    diary: {
      ...
      moodLabels: "Feeling words, if any fit",
      moodHelper:
        "You can choose up to 3 words, leave this blank, or choose an option that says it feels hard to name.",
      intensityLabel: "How strong does today feel, 1 to 10?",
      intensityLow: "Gentle",
      intensityHigh: "Strong",
      diaryEntry: "Diary entry",
      diaryPlaceholder:
        "Write a little, a lot, or just enough for today. You do not need to explain everything.",
      ...
      cancel: "Cancel",
      noMoodSelected: "No feeling words selected",
      moods: {
        "Not sure yet": "Not sure yet",
        "Mixed or hard to name": "Mixed or hard to name",
        "Prefer not to name it": "Prefer not to name it",
        Happy: "Happy",
        Hopeful: "Hopeful",
        Calm: "Calm",
        Grateful: "Grateful",
  ...
  "zh-Hans": {
    ...
    diary: {
      ...
      moodLabels: "如果有合适的感受词",
      moodHelper:
        "可以选择最多 3 个词，也可以不选；如果现在很难命名，也可以直接选择相应选项。",
      intensityLabel: "今天整体感觉有多强，1 到 10？",
      intensityLow: "轻一点",
      intensityHigh: "强一点",
      diaryEntry: "日记内容",
      diaryPlaceholder:
        "可以写一点，也可以写很多；不需要把所有事情都解释清楚。",
      entrySaved: "日记已保存。",
      saveEntry: "保存日记",
      saving: "正在保存...",
      pastEntries: "过去的记录",
      ...
      saveChanges: "保存修改",
      cancel: "取消",
      noMoodSelected: "还没有选择感受词",
      moods: {
        "Not sure yet": "还不确定",
        "Mixed or hard to name": "很复杂，难以命名",
        "Prefer not to name it": "暂时不想选择感受词",
        Happy: "开心",
        Hopeful: "有希望",
        Calm: "平静",
        Grateful: "感激",
  ...
  es: {
    ...
    diary: {
      ...
      moodLabels: "Palabras de sentimiento, si alguna encaja",
      moodHelper:
        "Puedes elegir hasta 3 palabras, dejar esto en blanco o elegir una opción que diga que es difícil nombrarlo.",
      intensityLabel: "¿Qué tan fuerte se siente hoy, del 1 al 10?",
      intensityLow: "Suave",
      intensityHigh: "Fuerte",
      diaryEntry: "Entrada del diario",
      diaryPlaceholder:
        "Puedes escribir poco, mucho o solo lo suficiente para hoy. No necesitas explicar todo.",
      ...
      cancel: "Cancelar",
      noMoodSelected: "No se eligieron palabras de sentimiento",
      moods: {
        "Not sure yet": "Todavía no lo sé",
        "Mixed or hard to name": "Mezclado o difícil de nombrar",
        "Prefer not to name it": "Prefiero no nombrarlo",
        Happy: "Feliz",
